...
// The Anthropic key stays server-side; this never sees it.
async function callModelLive({ transcript, existingProjects }) {
  const res = await fetch(BRIDGE_URL, {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify({ transcript, existingProjects })
  });
