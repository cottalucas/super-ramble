// Mirrors src/pipeline/referenceExamples.js exactly, byte for byte. Firebase
// Functions deploys only this functions/ directory as its own CommonJS
// package, so it cannot import the ESM module at ../src/pipeline: the same
// constraint that already forces STRUCTURE_SYSTEM_PROMPT in functions/index.js
// to be a hand-synced copy of src/pipeline/prompt.js's SYSTEM_PROMPT (see
// docs/resolution-log.md, 2026-07-06). scripts/check-prompt-sync.mjs diffs
...
/**
 * Format REFERENCE_EXAMPLES into a labeled prompt block. Mirrors
 * src/pipeline/referenceExamples.js's formatReferenceExamples exactly.
...
module.exports = { REFERENCE_EXAMPLES, formatReferenceExamples };
